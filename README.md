...
> Статус после начала remediation 22.08.2026: программный порядок duplex-страниц исправлен (`front-1, back-1, front-2, back-2`), добавлены long-edge/short-edge transforms, а заданный размер теперь относится к внешней рамке карточки. Гарантия точности всё ещё требует calibration offsets и физического прогона; скачивание PDF с кириллическим названием колоды также пока ломает реальный dev-сервер. Актуальный прогресс — в [плане ревизии](docs/REMEDIATION_PLAN.md).
