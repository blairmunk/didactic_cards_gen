...
Текущее состояние набора: 181 проходящий тест, 8 строгих `xfail`, общий branch coverage 99.02%. В persistence-набор входят fault injection атомарной записи, проверка rollback, structural corruption, traversal ID и конкурентные read–modify–write операции.
...
- Ошибка повреждения хранилища: не редактируйте рабочий JSON поверх ошибки; сравните его с соседним `.bak`, сделайте копию обоих файлов и восстановите последнюю проверенную версию вручную.
